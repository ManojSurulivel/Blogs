...
mongoose.connect(
  'mongodb+srv://prabu:prabu@61@cluster0.mzanulj.mongodb.net/?retryWrites=true&w=majority',
  {
...
app.get('/blogs', (req, res) => {
  ...
  product.find({}, (err, data) => {
    const arr = [];
    const updatedData = data?.filter(({ name }) => {
...
app.post('/blogs', upload.any(), (req, res) => {
  try {
    if (req.body) {
      let new_blog = new product();
